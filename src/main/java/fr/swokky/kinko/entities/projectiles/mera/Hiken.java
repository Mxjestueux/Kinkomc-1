...
public class Hiken extends AbilityProjectilesEntity {

    int timer = 0;
    int timerMax = 10;

    public Hiken(World worldIn) {
        super(worldIn);
        this.setDamage(2);
    }

    public Hiken(World worldIn, EntityLivingBase thrower) {
        super(worldIn, thrower);
        this.setDamage(2);
    }

    public Hiken(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.setDamage(2);
    }
    ...
    public void onUpdate()
    {
        ...
        if(timer == 3){
            this.setVelocity(motionX*1.5, motionY*1.5, motionZ*1.5);
        }
    }
}
