...
public class Kagero extends AbilityProjectilesEntity {

    int timer = 0;
    int timerMax = 10;

    public Kagero(World worldIn) {
        super(worldIn);
        this.setDamage(2);
    }

    public Kagero(World worldIn, EntityLivingBase thrower) {
        super(worldIn, thrower);
        this.setDamage(2);
    }

    public Kagero(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
        this.setDamage(2);
    }
